...
from async_sim import AsyncSimulation, run_session_until_stopped
...
def _book_fields(exchange) -> dict:
    """Top-of-book + depth; caller must hold sim._lock."""
...
def _metrics_fields(exchange) -> dict:
    ...
    return {
        ...
        "orders_fully_filled": len(m.filled_order_ids),
